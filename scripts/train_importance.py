"""Train dual-stream or full intent-aware models with Lightning."""
...
def main(cfg: DictConfig) -> None:
    ...
    model = _build_model(cfg, data.vocab_size)
    lit = ImportanceLitModule(
        model=model,
        loss_weights=OmegaConf.to_container(cfg.train.loss_weights, resolve=True),
    ...
    trainer.test(lit, datamodule=data, ckpt_path="best")
